...
Tech stack: Python (pandas) → PostgreSQL (SQLAlchemy) → Power BI
...
Extract – load the raw CSV export
Transform – clean missing values, engineer new features, standardize schema
Load – push the cleaned dataset into a PostgreSQL database
Visualize – build an interactive Power BI dashboard on top of the database
Dataset
...
Install PostgreSQL locally (or point .env at a remote instance) and create a database named customer_behavior
Copy .env.example to .env and fill in your credentials
Run python customer_shopping_etl.py to load the cleaned data into PostgreSQL
Open power_bi_present.pbix in Power BI Desktop, update the data source connection to your PostgreSQL instance, and refresh
Possible Extensions
